...
import { Plus, ArrowUpRight, ArrowDownRight, Wallet, PiggyBank, CreditCard, LineChart } from 'lucide-react';
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="bg-neutral-50 rounded-lg p-4 border border-neutral-200">
                ...
                <p className="text-2xl font-semibold mt-2">{formatCurrency(getTotalBalance())}</p>
              </div>
              ...
              {accounts.map((account) => (
                <Link
                  ...
                  className="block"
                >
                  <div className={`rounded-lg p-4 bg-gradient-to-r ${getAccountColor(account.type)} hover:shadow-lg transition-shadow`}>
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        ...
                        <div className="ml-3">
                          ...
                          <p className="text-xs text-white text-opacity-80">{account.number}</p>
                        </div>
                      </div>
                    </div>
